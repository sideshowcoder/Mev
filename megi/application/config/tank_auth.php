...
|--------------------------------------------------------------------------
*/
$config['website_name'] = 'megi.measr.net';
$config['webmaster_email'] = 'support@measr.net';
...
$config['recaptcha_public_key'] = '6Le8ZMMSAAAAABOcnd4NPhHoarE-zUoyDpo8OhYI';
$config['recaptcha_private_key'] = '6Le8ZMMSAAAAAA5iZUoO2bdNUYM8zR4Qw_tv1Zr2';
